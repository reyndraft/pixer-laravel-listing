...
export default function ProductDetailsPaper({ product, className }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col-reverse items-center justify-center py-3.5 xs:flex-row xs:gap-2.5 sm:py-4 md:gap-3.5 lg:w-[480px] lg:gap-4 lg:py-2 2xl:w-2/5 3xl:w-[480px]">
        {/*!isFreeItem ? (
          <AddToCart
        ...
        {Boolean(preview_url) && (
          <a
            ...
            rel="noreferrer"
            target="_blank"
            className="transition-fill-colors flex min-h-[58px] w-full max-w-[400px] flex-1 items-center justify-center gap-2 rounded border border-light-500 bg-red-500 py-3 px-4 font-semibold text-dark duration-200 hover:bg-red-600 hover:text-brand focus:bg-red-600 dark:border-dark-600 dark:text-light dark:hover:bg-red-600 dark:focus:bg-red-600 sm:h-12 md:px-5"
          >
            {t('text-visit-website') /*t('text-live-preview')*/}
          </a>
        )}
      </div>
    </div>
